...
# ISTESANGIZ YANGILANISH XABARI KO'RSATISH UCHUN SHU O'ZGARUVCHINI TO'LDIRING:
UPDATE_MESSAGE = ""  # "‼️ Botda yangi imkoniyatlar! /start tugmasini bosib, qayta ishga tushiring."
...
TEXTS = {
    ...
    'ru': {
        ...
        'ask_photo': "📸 Отправьте фото для заказа:",
        ...
        'confirm': "✅ Подтвердить",
        'not_subscribed': "Извините, вы ещё не подписались на канал! Подпишитесь и снова нажмите 'Подтвердить'.",
